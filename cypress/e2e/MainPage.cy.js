describe('Display Header on page load and 2 pokemon', () => {
  ...
  it('Should display two pokemon cards', () => {
    ...
    cy.get('.pokemon-display').children()
      .first().get('img').should('have.attr', 'src')
      .and('include', 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png')
    cy.get('.pokemon-display').children()
    ...
    cy.get('.pokemon-display').children()
      .last().get('img').should('have.attr', 'src')
      .and('include', 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png')
    cy.get('.pokemon-display').children()
  ...
  it('Should display two different cards on next click', () => {
    ...
    cy.get('.pokemon-img').should('have.attr', 'src')
      .and('include', 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/3.png')
    cy.get('.pokemon-display').children()
      .first().should('contain', 'grass')
    cy.get('.pokemon-display').children()
      .first().should('contain', 'poison')
    ...
    cy.get('.pokemon-display').get('img')
